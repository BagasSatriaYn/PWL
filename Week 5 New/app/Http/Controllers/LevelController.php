...
class LevelController extends Controller
{
    ...
    {
        $levels = LevelModel::select('level_id', 'level_kode', 'level_name'); // Ubah di sini
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'level_name' => 'required|string|max:100', // Ubah di sini
        ]);

        LevelModel::create([
            'level_kode' => $request->level_kode,
            'level_name' => $request->level_name, // Ubah di sini
        ]);
